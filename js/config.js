define([],function() {
    ...
    map: {
      options: {
        ...
        center : [-80.422218,37.227590],//[-80.42584,37.227298],
		zoom : 15,
		sliderStyle: "large",
		minZoom:12, 
		logo:false,
	...
	featureLayers : 
					[
						...
						,
						{
							...
							visible:true,
							opacity:1,
							identifyLayers:[{layerId:0, layerName:"Parking Lots",title:"${LOT_NAME} Parking Lot",fields:[{title:"Lot Name",value:"${LOT_NAME}"}, {title:"Lot Number",value:"${LOT_NUMBER}"}]}]
						},
						{
						...
						
						{
							...
							visible:true,
							opacity:1,
							identifyLayers:[{layerId:0, layerName:"Buildings",title:"${NAME}", fields:[{title:"Building Use",value:"${BLDG_USE}"}, {title:"Building Name",value:"${NAME}"}, {title:"Building Number",value:"${BLDG_NUM}"}, {title:"Address",value:"${STNUM:formatContent} ${STPREDIR:formatContent} ${STNAME:formatContent} ${STSUFFIX:formatContent} ${STPOSTDIR:formatContent}"},{title:"URL",value: "<a href='${URL:formatContent}'  target = '_blank' > Building Information </a>"}] }]
						},
						{
						...
						},
						{
							...
							opacity:1,
							identifyLayers:[
											{layerId:0, layerName:"Bus Stops",title:"Bus Stop ${ID}", fields: [{title:"ID",value:"${ID}"}, {title:"Bench",value:"${BENCH}"}, {title:"Bench Count",value:"${BENCHCOUNT}"},{title:"Have Shelter",value:"${SHELTER}"},{title:"Image",value:"<img src='${URL}' width='200px' height='200px' />"}]},
											{layerId:1, layerName:"Bike Racks", title:"Bike Rack ${ID}",fields: [{title:"ID",value:"${ID}"}, {title:"Condition",value:"${CONDITION}"},{title:"Covered",value:"${COVERED}"},{title:"Max Park Size",value:"${MAXPARK}"},{title:"Number of Bikes",value:"${NUMBIKES}"},{title:"Rack Style",value:"${RACKSTYLE}"},{title:"Number of Racks",value:"${RACKS}"},{title:"Rack Type",value:"${RACKTYPE}"},{title:"Image",value:"<img src='${URL}' width='200px' height='200px' />"}]}
										]
						},
						{
							label: "Accessibility",
	...
	configs:
	{
		...
		pointTolerance: 0.8,
		// https://developers.arcgis.com/net/store/api-reference/html/6a641604-55f8-4173-88ce-9d0c9791db24.htm
		
		//PictureMarker:"http://static.arcgis.com/images/Symbols/Basic/ArrowYellow.png",
		//PictureMarker:"http://static.arcgis.com/images/Symbols/Basic/GreenShinyPin.png", //RedShinyPin2.png",
		PictureMarker:"pictureSymbol.png",
		//PictureMarker:"http://static.arcgis.com/images/Symbols/Shapes/BluePin1LargeB.png"
	},
    about: {
